...
<div class="square" style="margin-top:10px; ">
            ...
            <?php
                ...
                if ($polaczenie->connect_errno != 0) {
                   ...
                   $sql = "select * from wydarzenia inner join uczestnicy on wydarzenia.id_kon = uczestnicy.id_konf WHERE uczestnicy.id_uzyt like (select id from users where login like '$login') ORDER BY data_rozp";
                   

                        $result = mysqli_query($polaczenie, $sql);

                    $row_cnt = mysqli_num_rows($result);
                    echo '<div id="logobezfloata"  style="padding-right: 100px; font-size:50px; margin-top: 10px;"> Liczba wydarzeń, do których jesteś aktualnie zapisany/a:  ' . $row_cnt . '</div>';
                    echo "<br>";
